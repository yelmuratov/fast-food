<div class="px-4">
        <section id="menu" class="content py-4">
            ...
            <!-- Modal -->
            <div wire:ignore.self class="modal fade" id="exampleFoodModal" tabindex="-1" role="dialog"
                aria-labelledby="exampleFoodModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file"
                                            ...
                                            id="Image_path" wire:model.blur="image_path">
                            ...
                            <div class="mt-3">
                                ...
                                @if ($image_path)
                                    <img src="{{ asset('storage/' . $image_path) }}" alt="Uploaded Image"
                            ...
                            <div class="mb-3">
                                ...
                                <select wire:model.defer="category_id" class="form-control" id="SelectCategory">
                    ...
                    <tbody>
                        @foreach ($foods as $food)
                            <tr>
                                ...
                                <td>
                                    <button type="button" wire:click="findEditing('{{ $food->id }}')"
                                        class="btn btn-sm btn-warning" data-toggle="modal"
                                        data-target="#exampleModalFood{{ $food->id }}">
                                    ...
                                    <!-- Modal -->
                                    <div wire:ignore.self class="modal fade" id="exampleModalFood{{ $food->id }}"
                                        tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabelFood{{ $food->id }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="exampleModalLabelFood{{ $food->id }}">Edit Food</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" wire:model.blur.defer="editingprice"
                                                            class="form-control @error('editingprice') is-invalid @enderror"
                                                            id="editingprice">
                                                        @error('editingprice')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="custom-file">
                                                                <input type="file"
                                                                    class="custom-file-input @error('editingimage') is-invalid @enderror"
                                                                    id="editingimage" wire:model.blur="editingimage">
                                                                <label class="custom-file-label"
                                                                    for="editingimage">Choose file</label>
                                                            </div>
                                                        </div>
                                                        @if ($editingimage)
                                                            <div class="mt-3">
                                                                <img src="{{ asset('storage/' . $editingimage) }}"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="editSelectCategory" class="form-label">Select
                                                            Category:</label>
                                                        <select wire:model.defer="editingcategory_id"
                                                            class="form-control" id="editSelectCategory">
                                                            @foreach ($categories as $category)
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        wire:click="updatefood">Save changes</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
